...
// const SignupModal = ({ currentRole }) => {
    
//     let FormComponent;
//     if (currentRole === 'signer') {
//         FormComponent = SignerForm;
//     } else if (currentRole === 'notary') {
//         FormComponent = NotaryForm;
//     } else if (currentRole === 'affiliate') {
//         FormComponent = AffiliateForm;
//     } else {
//         FormComponent = SignerForm;
//     }
...
//                     <Link 
//                         key={tab.role}
//                         href={`/signup/${tab.role}`} 
//                         className={`
//                             p-3 rounded-lg border transition duration-200 text-center
//                             ${currentRole === tab.role 
//                                 ? 'bg-blue-50 border-blue-600 text-blue-800 shadow-md' // Active Style
